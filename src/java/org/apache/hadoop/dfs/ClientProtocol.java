...
interface ClientProtocol {
    ...
    // File contents
    ///////////////////////////////////////
    // 获取某个文件的所有Block的信息，DFSInputStream会调用它先获取信息，再去datanode读数据
    /**
    ...
    // 创建一个新的文件，返回第一个Block，写完后向namenode去reportWrittenBlock
    // 随后可以再addBlock再申请一个新的Block
    /**
    ...
    // 向namenode说，我放弃写这个文件了，之前写过的Block也不要了
    /**
    ...
    // 向namenode说，我已经写完了文件，剩下的复制工作交给你了，如果你失败了
    // 请告诉我，我会再次来报告
    /**
    ...
    // client通知namenode，它还存活着。如果namenode长时间未收到
    // client的续租通知，它将会回收相应的lock和相应的新创建的文件
    /**
